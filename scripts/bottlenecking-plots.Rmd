...
g <- crossing(Genotype_Proportion=10^seq(-8,-3),Population=c(6e9,5e10),
    ...
    aes(color=Genotype_Proportion,linetype=Population)+
...
ggsave("../output/bottlenecking_cv-of-proportion.png",g,width=6,height=4)
